		...
		$(function() { 
			...
			function convertYouTubeUrl(url) {
				...
				if(match && match[2].length == 11) {
					return "<iframe src='https://www.youtube.com/v/"+match[2]+"?fs=0' frameborder='0' allowfullscreen width='"+iframe_width+"' height='"+iframe_height+"'></iframe>";
				} else {
					return false;
				}
			...
			embed_videos();
			$('.video_embed embed').click(function() {
				console.log("Clicked");
			});
		});
